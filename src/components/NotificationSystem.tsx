...
import { Bell, X, CheckCircle, AlertCircle, Info, Clock, User, ShoppingCart, Eye, EyeOff, Settings, Filter, Search, Trash2, Star, StarOff, Smartphone, ArrowRight } from 'lucide-react';
