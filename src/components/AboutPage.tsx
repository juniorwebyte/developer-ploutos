      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-12 border border-gray-100">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
            ...
            <p>
              Desenvolvido pela <strong>Webyte Hub</strong>, a PloutosLedger surgiu da necessidade real
        ...
        <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-3xl shadow-2xl p-8 md:p-12 mb-12 text-white">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
              ...
              <h3 className="font-bold text-lg mb-2">Webyte Hub</h3>
              <p className="text-emerald-100 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Webyte Hub</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                A <strong>Webyte Hub</strong> é uma empresa especializada no desenvolvimento de soluções
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Localizada na <strong>Rua Agrimensor Sugaya 1203, Bloco 5 Sala 32, São Paulo - SP</strong>, a Webyte Hub
