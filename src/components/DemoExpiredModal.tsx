...
export default function DemoExpiredModal({ isOpen, onClose, onContact }: DemoExpiredModalProps) {
  ...
  const handleWhatsAppContact = () => {
    ...
    const message = 'Olá! Gostaria de saber mais sobre o Sistema de Movimento de Caixa da Webyte Hub.';
  ...
  const handleEmailContact = () => {
    ...
    const body = 'Olá! Gostaria de saber mais sobre o Sistema de Movimento de Caixa da Webyte Hub.';
