...
class PixService {
  ...
  public static readonly CNPJ_PRINCIPAL = '29793949000178';
  public static readonly CNPJ_PRINCIPAL_FORMATADO = '29.793.949/0001-78';
  
  // Simular configuração da empresa (em produção viria do banco de dados)
  private companyConfig: CompanyConfig = {
    id: '1',
    nomeFantasia: 'Webyte Hub',
    razaoSocial: 'Webyte Hub LTDA',
    cnpj: '29793949000178', // CNPJ 29.793.949/0001-78
    inscricaoEstadual: '',
    endereco: {
      logradouro: '',
      numero: '',
  ...
  gerarPayloadPIXSimples(): string {
    ...
    const merchantName = this.companyConfig.nomeFantasia || 'Webyte Hub';
