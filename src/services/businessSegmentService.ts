...
class BusinessSegmentService {
  ...
  // Configuração para restaurantes
  ...
  // Configuração para supermercados
  private getSupermercadoConfig(segmentId: string): BusinessSegmentConfig {
    ...
    return {
      ...
      categoriasFinanceiras: {
        entradas: [
          { id: '1', nome: 'Venda de Produtos', tipo: 'entrada', ativa: true, obrigatoria: true, ordem: 1 }
        ],
        saidas: [
          ...generic.categoriasFinanceiras.saidas,
          { id: '4', nome: 'Reposição de Estoque', tipo: 'saida', ativa: true, obrigatoria: false, ordem: 1 }
        ]
      },
      funcionalidades: [
        { id: '1', nome: 'Controle de Estoque', codigo: 'controle_estoque', ativa: true },
        { id: '2', nome: 'Validade de Produtos', codigo: 'validade_produtos', ativa: true }
      ]
    };
  }
